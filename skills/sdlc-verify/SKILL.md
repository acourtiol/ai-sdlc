...
4. Check the three dimensions:
   ...
   - **Coherence** — review the full change range for logic errors, security and trust-boundary mistakes, regressions, error handling, and architectural fit. Compare it with the Design section of `spec.md`, `plan.md`, and existing codebase patterns.
