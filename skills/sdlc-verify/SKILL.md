...
description: >-
  ...
  test, or see if it works. Do not edit application source.
license: MIT
metadata:
  author: acourtiol
  version: "1.2"
...
4. Check the three dimensions:
   ...
   - **Correctness** — each `#### Scenario:` exercised: what you ran or drove, what you observed. Judge against the proposed outcome in `intent.md`.
